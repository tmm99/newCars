 ...
 * @LastEditTime: 2019-12-15 19:53:57
 * @LastEditors: 席鹏昊
    ...
    <div class="content">
      <div class="top">
        ...
        <div class="contLeft">
          <p>{{carName}}</p>
          <p>
            <span>{{detailData.list[0].market_attribute.year}}款</span>
            <span class="twospan">{{detailData.list[0].car_name}}</span>
          </p>
        </div>
      </div>
      <!-- 个人信息 -->
...
.lowPrice {
  ...
  .footer {
    ...
    ul {
      ...
      li {
        position: relative;
        padding: 0.26rem 0 0.26rem 0.7rem;
        border-bottom: 1px solid #eee;
        box-sizing: border-box;
        height: 1.65rem;
        p {
